...
def UVW(ra=None, dec=None, pmra=None, pmdec=None, vrad=None, plx=None, warnings=True):
    ...
    The function calculates the U, V, and W components of the galactic space velocity relative to the LSR using transformations from equatorial to galactic coordinates. It applies a series of matrix operations to convert the input coordinates and velocities to the desired components.

    The output is an array [U, V, W] representing the galactic space velocity components in km/s. The U component is positive toward the Galactic anti-center, the V component is positive in the direction of Galactic rotation, and the W component is positive toward the North Galactic Pole.

    The function includes a commented line that prints the calculated velocities. If you want to see the velocities printed, uncomment that line by removing the # character at the beginning of the line.
...
def UVW_prob_err(ra=None, dec=None, pmra=None, pmdec=None, vrad=None, plx=None, ra_err=None, dec_err=None, pmra_err=None, pmdec_err=None, vrad_err=None, plx_err=None, display=True, N=1000):
    ...
    This function calculates the mean and standard deviation of the U, V, and W galactic space velocity components and the relative probabilities
    of belonging to different galactic populations (Thin disk, Thick disk, and Halo) for a given set of astronomical parameters and their uncertainties.
...
UVW_prob_err(ra=None, dec=12, pmra=None, pmdec=None, vrad=None, plx=None, ra_err=None, dec_err=None, pmra_err=None, pmdec_err=None, vrad_err=None, plx_err=None, display=True, N=1000)